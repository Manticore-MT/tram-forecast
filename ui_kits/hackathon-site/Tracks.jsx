const { Button, Card, Badge, Tag, Icon, Stat, Timeline, Accordion } = window.DesignSystem_8e46b6;
    ...
    <section style={{ background: "var(--bg-surface)", padding: "var(--space-24) 0" }}>
      <div style={siteShell.wrap}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-6)" }}>
          <Card tone="raised" padding="var(--space-8)">
            <img src="../../assets/logo-mttech-white.svg" alt="МТТЕХ" style={{ height: 34, marginBottom: "var(--space-6)" }} />
          ...
          <Card tone="raised" padding="var(--space-8)">
            <img src="../../assets/logo-tim-white.svg" alt="Транспортные Инновации Москвы" style={{ height: 44, marginBottom: "var(--space-5)" }} />
...
function SiteFooter({ onRegister }) {
  return (
...
Object.assign(window, { TRACKS, Tracks, Prizes, Schedule, Faq, Experts, Organizers, SiteFooter });
