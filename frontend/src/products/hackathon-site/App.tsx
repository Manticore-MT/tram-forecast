...
import { Dialog, Button, Input, Select, Checkbox, Radio, Toast, Icon } from "../../components";
import { Nav, Hero, About } from "./Sections";
import { TRACKS, Tracks, Prizes, Schedule, Faq, Experts, Organizers, SiteFooter } from "./Tracks";
...
function RegisterDialog({ open, onClose, onDone }: RegisterDialogProps) {
